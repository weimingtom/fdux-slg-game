...
//单位类,由单位组成小队
class UnitGrapIG:public ParticleUniverse::ParticleSystemListener 
{
public:
	UnitGrapIG(std::string unitName,Ogre::SceneNode* node);
	~UnitGrapIG(void);
	...
	WeaponGrapIG* mMainWeapon;
	WeaponGrapIG* mSecWeapon;
	WeaponGrapIG* mShield;
