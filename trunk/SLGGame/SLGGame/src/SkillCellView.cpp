...
void SkillCellView::getCellDimension(MyGUI::Widget* _sender, MyGUI::IntCoord& _coord, bool _drop)
{
	if (_drop)
...
SkillCellView::SkillCellView(MyGUI::Widget* _parent) :
wraps::BaseCellView<SkillItemData*>("CellView.layout", _parent)
{
...
void SkillCellView::update(const MyGUI::IBDrawItemInfo& _info, SkillItemData* _data)
{
	if (_info.update)
	{
		if (!_data->isEmpty())
