...
void AreaGrap::creatArea(std::string mat)
{
	...
	for(int n = 0; n < mCoordList.size() / 2 ; n++)
	{
		...
		mAreaObj->position(startpos + x * TILESIZE, 0.5f, startpos + y * TILESIZE);
		mAreaObj->colour(1.0f,1.0f,1.0f);
		mAreaObj->normal(0.0f,1.0f,0.0f);
		mAreaObj->position(startpos + (x+1) * TILESIZE, 0.5f, startpos + (y+1) * TILESIZE);
		mAreaObj->colour(1.0f,1.0f,1.0f);
		mAreaObj->normal(0.0f,1.0f,0.0f);
		mAreaObj->position(startpos + (x+1) * TILESIZE, 0.5f, startpos + y * TILESIZE);
		mAreaObj->colour(1.0f,1.0f,1.0f);
		mAreaObj->normal(0.0f,1.0f,0.0f);
		mAreaObj->position(startpos + (x+1) * TILESIZE, 0.5f, startpos + (y+1) * TILESIZE);
		mAreaObj->colour(1.0f,1.0f,1.0f);
		...
		mAreaObj->colour(1.0f,1.0f,1.0f);
		mAreaObj->normal(0.0f,1.0f,0.0f);
		mAreaObj->position(startpos + x * TILESIZE, 0.5f, startpos + (y+1) * TILESIZE);
		mAreaObj->colour(1.0f,1.0f,1.0f);
		mAreaObj->normal(0.0f,1.0f,0.0f);		
	}
	mAreaObj->end();
