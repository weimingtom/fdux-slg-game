...
bool SoldierTableModule::setData(const QModelIndex &index, const QVariant &qvalue,int role /* = Qt::EditRole */)
{
	if (index.isValid() && role == Qt::EditRole) 
	{
		...
		case 4:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_ATTACK, qvalue.toFloat());
		case 5:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_RANGEDATTACK, qvalue.toFloat());
		case 6:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_DEFENSE, qvalue.toFloat());
		case 7:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_FORMATION, qvalue.toFloat());
		case 8:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_INITIATIVE, qvalue.toFloat());
		case 9:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_ACTIONPOINT, qvalue.toFloat());
		case 10:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_DETECTION, qvalue.toFloat());
		case 11:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_COVERT, qvalue.toFloat());
		case 12:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_INJURY, qvalue.toFloat());
		case 13:
			return DATAMANAGER().SetAttribute(SOLDIER_TAG, id, ATTR_COUNTER, qvalue.toFloat());
		case 14:
