#ifndef SWEAPONTABLEMODULE_H
#define SWEAPONTABLEMODULE_H

#include <QAbstractTableModel>

class SWeaponTableModule : public QAbstractTableModel
{
	Q_OBJECT

public:
	SWeaponTableModule(QObject *parent = 0);
	~SWeaponTableModule();
