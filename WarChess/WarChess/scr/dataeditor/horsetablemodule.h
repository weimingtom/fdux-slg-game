#ifndef HORSETABLEMODULE_H
#define HORSETABLEMODULE_H

#include <QAbstractTableModel>

class HorseTableModule : public QAbstractTableModel
{
	Q_OBJECT

public:
	HorseTableModule(QObject *parent = 0);
	~HorseTableModule();
