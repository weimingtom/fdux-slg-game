...
MoveCutScenece::MoveCutScenece(unsigned int id,std::vector<Ogre::Vector2>& grids,Ogre::Vector2& currentGrid)
{
...
MoveCutScenece::~MoveCutScenece(void)
{
}
...
void MoveCutScenece::updateCutScence( unsigned int deltaTime )
{
